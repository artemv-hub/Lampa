(function () {
  ...
  style.textContent = `
    ...
    .card__watched { font-weight: bold; font-size: 1.2em; left: 50%; bottom: -0.8em; border-radius: 1em; padding: 0.2em 0.4em; color: #ffc800; background: rgb(29, 31, 32); position: absolute; transform: translate(-50%); white-space: nowrap; }
