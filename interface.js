(function () {
  ...
  style.textContent = `
    ...
    .card__watched { font-weight: bold; font-size: 1em; left: 50%; bottom: 0.2em; border-radius: 0.4em; padding: 0.2em 0.4em; color: #fff; background: rgb(50, 50, 50); position: absolute; transform: translate(-50%); white-space: nowrap; }
